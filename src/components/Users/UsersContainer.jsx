...
import { follow, getUsers, getUsersMore, setCurrent, unfollow } from '../../redux/usersReducer';
...
export default compose(
  connect(mapStateToProps, { follow, unfollow, setCurrent, getUsers, getUsersMore }),
  WithAuthRedirect
)(UsersContainer);
